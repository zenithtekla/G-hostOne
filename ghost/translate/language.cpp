...
string CLanguage :: PlayersNeedToReady(string user)
{
	string Out = m_CFG->GetString( "lang_1007", "lang_1007" );
	Replace( Out, "$USER$", user );
	return Out;
}
string CLanguage :: PlayersPinged(string user)
{
	string Out = m_CFG->GetString( "lang_1008", "lang_1008" );
	Replace( Out, "$USER$", user );
	return Out;
}
string CLanguage :: PlayerReady(string user)
{
	string Out = m_CFG->GetString( "lang_1009", "lang_1009" );
	Replace( Out, "$USER$", user );
	return Out;
}
string CLanguage :: EverybodyReady( )
{
	string Out = m_CFG->GetString( "lang_1010", "lang_1010" );
	return Out;
}
string CLanguage :: PlayerIsReady( )
{
	string Out = m_CFG->GetString( "lang_1011", "lang_1011" );
	return Out;
}
string CLanguage :: RMKCounter( )
{
	string Out = m_CFG->GetString( "lang_1012", "lang_1012" );
	return Out;
}
string CLanguage :: VoteForRMK(string user)
{
	string Out = m_CFG->GetString( "lang_1013", "lang_1013" );
	Replace( Out, "$USER$", user );
	return Out;
}
string CLanguage :: UnVoteForRMK(string user)
{
	string Out = m_CFG->GetString( "lang_1014", "lang_1014" );
	Replace( Out, "$USER$", user );
	return Out;
}
string CLanguage :: RMKSucceeded( )
{
	string Out = m_CFG->GetString( "lang_1015", "lang_1015" );
	return Out;
}
string CLanguage :: GameOverIn( string time )
{
	string Out = m_CFG->GetString( "lang_1016", "lang_1016" );
	Replace( Out, "$TIME$", time );
	return Out;
}
string CLanguage :: FFCounter( string vote1, string count1, string vote2, string count2 )
{
	string Out = m_CFG->GetString( "lang_1017", "lang_1017" );
	Replace( Out, "$VOTE1$", user );
	Replace( Out, "$COUNT1$", user );
	Replace( Out, "$VOTE2$", user );
	Replace( Out, "$COUNT2$", user );
	return Out;
}
string CLanguage :: PlayerHasFF( string user )
{
	string Out = m_CFG->GetString( "lang_1018", "lang_1018" );
	Replace( Out, "$USER$", user );
	return Out;
}
string CLanguage :: PlayerHasOath( string user )
{
	string Out = m_CFG->GetString( "lang_1019", "lang_1019" );
	Replace( Out, "$USER$", user );
	return Out;
}
string CLanguage :: TheScourgeWin( )
{
	string Out = m_CFG->GetString( "lang_1020", "lang_1020" );
	Replace( Out, "$USER$", user );
	return Out;
}
string CLanguage :: TheSentinelWin( )
{
	string Out = m_CFG->GetString( "lang_1021", "lang_1021" );
	return Out;
}
string CLanguage :: BothTeamsMustContainAPlayer( )
{
	string Out = m_CFG->GetString( "lang_1022", "lang_1022" );
	return Out;
}
string CLanguage :: SureForStartGame( )
{
	string Out = m_CFG->GetString( "lang_1023", "lang_1023" );
	return Out;
}
