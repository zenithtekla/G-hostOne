...
public:
	...
	BYTEARRAY SEND_W3GS_REFRESHGAME( uint32_t hostCounter, uint32_t playerSlots, uint32_t playersin ); // Neolo
	// BYTEARRAY SEND_W3GS_DECREATEGAME( );
	BYTEARRAY SEND_W3GS_DECREATEGAME( uint32_t hostCounter ); // Neolo
