...
//	string HasPlayedDotAGamesWithThisBot( string user, string totalgames, string totalwins, string totallosses, string totalkills, string totaldeaths, string totalcreepkills, string totalcreepdenies, string totalassists, string totalneutralkills, string score );
	...
	string PlayersNeedToReady(string user);
	string PlayersPinged(string user);
	string PlayerReady(string user);
	string EverybodyReady( );
	string PlayerIsReady( );
	string RMKCounter( );
	string VoteForRMK(string user);
	string UnVoteForRMK(string user);
	string RMKSucceeded( );
	string GameOverIn( string time );
	string FFCounter( string vote1, string count1, string vote2, string count2 );
	string PlayerHasFF( string user );
	string PlayerHasOath( string user );
	string TheScourgeWin( );
	string TheSentinelWin( );
	string BothTeamsMustContainAPlayer( );
	string SureForStartGame( );
